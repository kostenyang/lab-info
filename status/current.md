...
**Offline depot** (`rtolab-depotsrv` @ 172.16.10.50, nginx :8888): full 9.1.0.0 INSTALL set + all async patch builds up to **SDDC Manager `9.1.0.0200.25496021`** (2026-06-25, latest available) + `0100` (2026-06-05) for ESX/HCX/NSX/vCenter. Updated to latest 2026-06-25 (`11 binaries`, 0 FAILED). vmdk 180 GB, 24 GB free. No DNS record / no 521 conflict (.50 is jumpbox segment). See `runbooks/depot-server.md`.
